...
module vga_console
  ...
  (
    ...
    output reg [11:0] text_rgb,  //output color
    ...
    input wire [11:0] text_back_color,

    input wire [6:0] r_MAX_X
  );

  //Screen tile parameters
  //localparam MAX_X = 30;      //Number of horizontal tiles
  localparam MAX_Y = 31;      //Number of tile rows
...
//  wire cursor_on;
  ...
  reg [11:0] font_rgb;      //color for text
  reg [11:0] font_inv_rgb;  //color for text with cursor on top
  ...
  begin
    ...
    //   begin
    //     font_rgb = (font_bit) ? 8'b00011100 : 8'b00000000; //green:black
    //     font_inv_rgb = (font_bit) ? 8'b0000000 : 8'b00011100; //black:green
    //   end
  end
  ...
  begin
        text_rgb = font_rgb;
        //text_rgb = {font_rgb[7:5], 1'b0, font_rgb[4:2], 1'b0, font_rgb[1:0], 2'b0};
  end
