...
//Set Registers for AHB Address State
  ...
  assign sel_uart_control = (last_HADDR == 32'h5180_0004);
  
  //Set text region width
  always @(posedge HCLK or negedge HRESETn)
  begin
    if(!HRESETn)
      r_uart_control <= 3'b000;
    else if (last_HTRANS[1] & last_HSEL & sel_uart_control )
      r_uart_control <= HWDATA[2:0];
  end
  ...
  BAUDGEN uBAUDGEN(
    ...
    .resetn(HRESETn),
    .baudtick(b_tick),
    .baudcontrol(r_uart_control[1:0])
  );
