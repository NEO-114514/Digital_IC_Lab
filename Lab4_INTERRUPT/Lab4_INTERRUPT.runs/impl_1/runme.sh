...
HD_PWD='D:/Digital_IC/Digital_IC_Lab/Lab4_INTERRUPT/Lab4_INTERRUPT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ARMSOC_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ARMSOC_TOP.tcl -notrace
