...
HD_PWD='D:/Digital_IC/Digital_IC_Lab/Lab4_INTERRUPT/Lab4_INTERRUPT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARMSOC_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ARMSOC_TOP.tcl
